...
/* Styling the body of kattiewebsite.html */
body {
    background-color: #fce4ec; /* Light pink background color */
    margin-left: 200px; /* Pushing body text 200px from the left */
    margin-right: 200px;
    text-align: center;
...
h1 {
    ...
    padding: 20px; /* Add padding to the title for better visual appearance */
}
    ...
    <div class="container">
        <div class="content">
            <div class="text-section">
                <h1>Kattie <3</h1>
                <p>Before I begin this is a website dedicated to Kattie and all the things we do, this is an ongoing project that I hope to keep and publish so it can be looked back on years from now. </p> 
                <br>
